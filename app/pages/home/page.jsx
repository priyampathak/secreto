...
function Page() {
  ...
  const handleScroll = () => {
    ...
    const newMarginTop = Math.max(
      0,
      (window.innerHeight - window.innerHeight * newScale) / 2
    );
        ...
        {/* this code for desktop view */}
          <div className="py-6 overflow-hidden">
            ...
            >
              <video
                ...
                style={{
                  ...
                  transition:
                    "transform 0.2s ease-out, margin-top 0.2s ease-out",
            ...
            <div className="mx-20 flex">
              <div className="w-1/4 relative mr-6 h-5/6">
                ...
                <div className="absolute top-0 left-0 w-full h-full flex items-end justify-center ">
                  <h1 className="text-center bg-black bg-opacity-20 w-full p-2 font-medium">
                    Face & Neck
                  </h1>
                </div>
              </div>
            ...
            <div className="flex w-screen mx-10 my-6">
              <div className="w-1/2">
                <Image src={serum} width={650} height={600} />
              </div>
              <div className="w-1/2 py-14 pl-10">
                <h1 className="text-4xl py-4">Carmell Club</h1>
                <ul className="list-disc ml-4 w-3/5 text-gray-500">
                  <li className="py-2">
                    The Carmell Club is a community of discerning beauty icons
                    who demand high-performance, luxury skincare. We expect
                    better than mass market products.
                  </li>
                  <li className="py-2">
                    Our members are powerful, busy people with no time for fussy
                    and incomplete skincare routines.
                  </li>
                  <li className="py-2">
                    Our members have access to the best professional insights
                    and science.
                  </li>
                  <li className="py-2">
                    Our skincare reflects our commitment to a healthy lifestyle
                    that extends our love and enjoyment of the la dolce vita.
                  </li>
                </ul>
                <button
            ...
            <div className="flex w-screen my-8 mx-12">
              <div className="w-1/2">
                <Image src={blackwhite} width={650} height={600} />
              </div>
              <div className="w-1/2 py-14 pl-10">
                ...
                <p className="w-3/4 py-4 text-gray-500">
                  ...
                  Carmell Secretome containing 1000+ growth factors, proteins
                  and peptides derived from Human Platelet Enriched Plasma.
                </p>
                <button
                  className=" border-black p-3 px-5 text-black my-4 hover:bg-orange-500 hover:text-white"
                  style={{ borderWidth: "1px" }}
            ...
            <div className="w-screen py-10">
              <h1 className="text-center text-3xl font-medium">
                Carmell Cosmetics Complete Care
              </h1>
              ...
              <div className="mx-20 my-16 flex">
                <div className="w-1/4 mx-3">
                  ...
                  <h1 className="text-center pr-4 my-10 font-semibold text-lg">
                    Carmell Secretome
                  </h1>
                </div>
                <div className="w-1/4 mx-3">
